...
$product_box = $_SESSION["product_box"];
...
<head>
    ...
    <title>cropllet tool - Inside Box</title>
</head>
<body>
   <!-- navbar start -->
...
<?php
   require_once "config.php";
   $sql = "SELECT count(*) FROM products where product_box = '$product_box'";
...
<section class="text-gray-700 body-font">
  <div class="container-fluid px-6 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Recieve products inside Box</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">You can recieve the products that are inside the Box</p>
    </div>
    <div class=" w-full mx-auto overflow-auto">
    <p style="padding: 10px;background: #5DADE2; color: white;" class= "text-center">Total Number of Products inside box: <?php echo $row[0]; ?></p>
    ...
    <table class="table-auto w-full text-left whitespace-no-wrap">
        <thead>
          <tr>
            ...
            <th class="py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200">Action</th>
            <!-- <th class="py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200">Product Status</th>
...
$sql = "SELECT * FROM products where product_box = '$product_box' order by product_box desc"; 
...
?>
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="">
          ...
          <tr>
            ...
            <td class="border-t-2 border-gray-200  ">
              <input readonly class="bg-white rounded focus:outline-none focus:border-indigo-500 text-base  py-2 mb-4" value="<?php echo $row["product_name"]; ?>" name="product_name" type="text">
            </td>

            <td class="border-t-2 border-gray-200  ">
              <input readonly class="bg-white rounded focus:outline-none focus:border-indigo-500 text-base  py-2 mb-4" value="<?php echo $row["product_quantity"]; ?>" name="product_quantity" type="text">
            </td>
            ...
            <td class="border-t-2 border-gray-200  ">
              <input readonly class="bg-white rounded focus:outline-none focus:border-indigo-500 text-base  py-2 mb-4" value="<?php echo $row["recieved_status"]; ?>" name="recieved_status" type="text">
            </td>

             <td class="border-t-2 border-gray-200 px-4 py-3">
                <button type="submit" class="text-white bg-green-500 border-0 py-2 px-6 rounded">Recieve</button>
...
<p style="padding: 10px; color:white;" class= "text-center"><a style="background:grey; padding:10px 30px 10px 30px; border-radius: 5px;" href="recieve_box.php">Back</a> </p>
